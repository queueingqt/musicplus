...
open class StubMusicApi(override val serverId: String = "srv") : MusicApi {
    ...
    override suspend fun star(id: String): Unit = unstubbed("star")
    override suspend fun unstar(id: String): Unit = unstubbed("unstar")
    ...
    override suspend fun renamePlaylist(playlistId: String, name: String): Unit = unstubbed("renamePlaylist")
    override suspend fun addSongToPlaylist(playlistId: String, songId: String): Unit = unstubbed("addSongToPlaylist")
    override suspend fun removeSongFromPlaylist(playlistId: String, songIndex: Int): Unit = unstubbed("removeSongFromPlaylist")
    override suspend fun reorderPlaylist(playlistId: String, name: String, songIds: List<String>): Unit = unstubbed("reorderPlaylist")
    override suspend fun deletePlaylist(id: String): Unit = unstubbed("deletePlaylist")
    override fun streamUrl(songId: String, maxBitRateKbps: Int?): String = unstubbed("streamUrl")
    override suspend fun streamToFile(songId: String, destination: File, maxBitRateKbps: Int?, lease: FetchGate.Lease?): Unit = unstubbed("streamToFile")
    override suspend fun downloadToFile(songId: String, destination: File, lease: FetchGate.Lease?): Unit = unstubbed("downloadToFile")
